...
import numpy as np
from src.sampler import SequentialSampler
from src.sampler import SamplerPool
...
class StepSampler(SequentialSampler):
    ...
    def __init__(self,dataManager,samplerName):
        ...
        '''
        super().__init__(dataManager.getDataManagerForName(samplerName), samplerName, [])
    ...
    def setInitStateFunction(self,initStateSampler,samplerName=None):
        ...
        self._addSamperFunctionToPool("Policy",samplerName,initStateSampler,-1)
    ...
    def setTransitionFunction(self,transitionFunction,samplerName=None):
        ...
        self._addSamperFunctionToPool("TransitionSampler",samplerName,transitionFunction,-1)
    ...
    def setRewardFunction(self,rewardFunction,samplerName=None):
        ...
        self._addSamperFunctionToPool("Policy",samplerName,rewardFunction,-1)

    #change removed all flush functions. e.g. use getSamplerPool("Policy").flush()
    ...
    def _endTransition(self,data,*args):
        ...
        data.setDataEntry("timeSteps",np.ones((numElements,1))*layerIndexNew[-1],layerIndexNew.copy())
    ...
    def _initSamples(self,data,*args):
        ...
        #in matlab we have some lines commented out that set states & timeSteps, are they still needed?
